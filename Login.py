...
class Ui_login(object):
    ...
    def Openchoix(self):
        ...
        try:
            ...
            database = pd.read_excel(r"Matricule.xlsx",sheet_name="Opérateurs")
            print(database)
            print(Matricule)
            ...
            if Matricule.lower() in [x.lower() for x in DB]:  # Case-insensitive comparison
                ...
                self.ui = Ui_Proddata()
                self.ui.setupUi(self.window, self.window)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Login Opérateur"))


        self.label_2.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\"vertical-align:super;\">Bonjour madame pouvez-vous taper </span></p><p align=\"center\"><span style=\"vertical-align:super;\">votre matricule ?</span></p><p align=\"center\"><span style=\"vertical-align:super;\">مرحبا سيدتي ، هل يمكنك كتابة رقمك ؟</span></p></body></html>"))
